            ...
            <div class="bg-white overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.05)] sm:rounded-[3rem] border border-gray-100">
                <form method="POST" action="{{ route('clubs.store') }}" enctype="multipart/form-data" class="p-8 md:p-14 space-y-10">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                        <div class="space-y-8">
                            ...
                            <div>
                                ...
                                <x-text-input id="creation_date" name="creation_date" type="date" class="block w-full border-gray-100 bg-gray-50/50 focus:bg-white focus:ring-indigo-500 rounded-2xl py-4" required />
                            </div>
                            ...
                            <div>
                                ...
                                <select id="category" name="category" class="block w-full border-gray-100 bg-gray-50/50 focus:bg-white focus:border-indigo-500 focus:ring-indigo-500 rounded-2xl py-4 shadow-sm transition-all">
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="relative flex-grow group">
                                <label for="logo" class="flex flex-col items-center justify-center w-full h-full min-h-[250px] border-2 border-dashed border-gray-200 rounded-[2.5rem] bg-gray-50/30 cursor-pointer hover:bg-indigo-50/50 hover:border-indigo-300 transition-all overflow-hidden">
                                    
                                    <img id="logo-preview" class="hidden absolute inset-0 w-full h-full object-cover rounded-[2.5rem] z-0" />
                                    
                                    <div id="upload-placeholder" class="relative z-10 flex flex-col items-center text-center p-6">
                                        ...
                                        <p class="text-xs text-gray-400 mt-1 uppercase tracking-widest font-semibold">SVG, PNG, JPG (MAX. 1MB)</p>
                                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="5" class="block w-full border-gray-100 bg-gray-50/50 focus:bg-white focus:ring-indigo-500 rounded-3xl shadow-sm placeholder-gray-400 p-6" placeholder="Describe the mission and goals of this club..." required></textarea>
    ...
    <script>
        function handleLogoPreview(event) {
            ...
            reader.onload = function() {
                ...
                placeholder.classList.add('opacity-0'); // Hide text but keep layout
            }
